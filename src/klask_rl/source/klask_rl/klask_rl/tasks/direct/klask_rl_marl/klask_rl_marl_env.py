...
from .klask_rl_marl_env_cfg import KlaskRlMarlEnvCfg


class KlaskRlMarlEnv(DirectMARLEnv):
    cfg: KlaskRlMarlEnvCfg

    def __init__(self, cfg: KlaskRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
